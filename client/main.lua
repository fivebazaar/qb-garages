        ...
        if isPointInside then
            ...
            CreateThread(function()
                ...
                --     if IsControlJustReleased(0, 38) then
                    garage = exports['qb-radialmenu']:AddOption(
                        {
                            id = 'garage',
                            title = displayText,
                            icon = 'square-parking',
                            type = 'client', -- event type to call, client/server
                            zone = zone,
                            event = 'akyolgarage', -- event name to call
            ...
            if garage then
            exports['qb-radialmenu']:RemoveOption(garage)
            end
...
RegisterNetEvent('akyolgarage', function(data)
